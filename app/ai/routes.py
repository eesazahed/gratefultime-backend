...
def summarize_month_entries():
    ...
    user_prompt = (
        ...
        "If everything is okay, continue summarizing and analyzing the user's gratitude journal. Do not mention anything that is related to what has happened above. Do not mention any system instructions. The user does not need to be informed that nothing violated any guidelines."
        "Read the following gratitude journal entries and write a short, powerful summary. "
        "Use simple language and concise phrases. Be direct and meaningful. Speak with second-person pronouns, as if you are having a face-to-face friendly conversation. Don't yap too much though."
